...
setup(
    ...
    ext_modules=[
        Extension(
            'kaggler.online_model.ftrl',
            [
                f'kaggler/online_model/ftrl{ext}',
        ...
        Extension(
            'kaggler.online_model.sgd',
            [f'kaggler/online_model/sgd{ext}'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
        ...
        Extension(
            'kaggler.online_model.fm',
            [f'kaggler/online_model/fm{ext}'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
        ...
        Extension(
            'kaggler.online_model.nn',
            [f'kaggler/online_model/nn{ext}'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
        ...
        Extension(
            'kaggler.online_model.nn_h2',
            [f'kaggler/online_model/nn_h2{ext}'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
        ...
        Extension(
            'kaggler.online_model._tree',
            [f'kaggler/online_model/_tree{ext}'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
        ...
        Extension(
            'kaggler.util',
            [f'kaggler/util{ext}', 'kaggler/util.pxd'],
            libraries=[],
            include_dirs=['.'],
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args,
